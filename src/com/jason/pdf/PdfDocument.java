...
public class PdfDocument {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream("d://AsianTest.pdf"));

			/**
			 * 新建一个字体,iText的方法 STSongStd-Light 是字体，在iTextAsian.jar 中以property为后缀
			 * UniGB-UCS2-H 是编码，在iTextAsian.jar 中以cmap为后缀 H 代表文字版式是 横版， 相应的 V代表竖版			 * 
			 */
			...
			Paragraph title11 = new Paragraph("This is Section 1 in Chapter 1中文", italic_fontChinese);
			...
			// 定义一个图片
			/*
			 * Image jpeg = Image.getInstance("E:/01.jpg"); // 图片居中
			 * jpeg.setAlignment(Image.ALIGN_CENTER); document.add(jpeg);
			 */
